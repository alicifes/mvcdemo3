...
var _default = View;
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"computed.js":[function(require,module,exports) {
"use strict";
...
var c = {
  ...
  initV: function initV() {
    c.v = new _View.default({
      ...
      render: function render(n) {
        ...
        (0, _jquery.default)(c.v.computedHtml.replace(/{{currentNumber}}/, n)).appendTo(c.v.el);
      }
    });
  },
  ...
  bindMethods: function bindMethods() {
    ...
    for (var key in hashMap) {
      ...
      var methods = c[value];
      c.v.el.on('click', key, methods); // $(key).on('click',key,methods)
    }
  },
  add: function add() {
    console.log('here');
    m.update({
      n: m.data.currentNumber += 10
    });
  },
  sub: function sub() {
    m.update({
...
var _default = c;
exports.default = _default;
},{"jquery":"../node_modules/jquery/dist/jquery.js","../base/Model.js":"../base/Model.js","../base/View.js":"../base/View.js"}],"selectBox.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
